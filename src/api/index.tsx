...
export const createComment = (content: string, postId: string) => {
...
export const toggleLike = (itemType: string, itemId: string) => {
  return CustomFetch(API_URLS.toggleLike(itemId, itemType), {
    method: "POST",
  });
};
export const searchUsers = (searchItem: string) => {
  return CustomFetch(API_URLS.searchUsers(searchItem), {
    method: "GET",
  });
};
